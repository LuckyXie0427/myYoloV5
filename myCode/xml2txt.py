...
def convert_annotation(image_id):
    ...
    并将四个物理量归一化"""
    in_file = open(DATASET_PATH + 'Annotations/%s' % (image_id), encoding='UTF-8') #
...
if __name__ == '__main__':
    DATASET_PATH = "/home/cse-305/xwq_files/python_project/ssd.pytorch-master/data/VOCdevkit/"
    make_label_txt()
    show_labels_img("part2_001927")

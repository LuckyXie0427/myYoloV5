...
def run(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        t = time_synchronized()
        # out = non_max_suppression(out, conf_thres, iou_thres, labels=lb, multi_label=False, agnostic=single_cls,soft=False,merge=False)
        out = non_max_suppression(out, conf_thres, iou_thres, labels=lb, multi_label=False, agnostic=single_cls,merge=False)
    ...
    print(0,'--','tp',tp_0,'fp',fp_0)
    print(1, '--', 'tp', tp_1, 'fp', fp_1)
    print(2, '--', 'tp', tp_2, 'fp', fp_2)
    print(3, '--', 'tp', tp_3, 'fp', fp_3)
    print(4, '--', 'tp', tp_4, 'fp', fp_4)
    print(5, '--', 'tp', tp_5, 'fp', fp_5)
    print(6, '--', 'tp', tp_6, 'fp', fp_6)
    print(7, '--', 'tp', tp_7, 'fp', fp_7)
    print(8, '--', 'tp', tp_8, 'fp', fp_8)
    print(9, '--', 'tp', tp_9, 'fp', fp_9)
    print(10, '--', 'tp', tp_10, 'fp', fp_10)
